...
О: Кроме вызова человека в этом чате, можно написать напрямую в техподдержку сайта:
   email timofeeva-online@mail.ru или Telegram https://t.me/timofeeva_online_support
   (это отдельный канал от общей новостной Telegram-группы школы).
