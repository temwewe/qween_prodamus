...
def call_qwen_api(message_text, student_id, history=None, global_dates_text="", current_price_text="",
    ...
    system_prompt = (
        ...
        "*текст* - ОДНА звёздочка с каждой стороны, это формат Telegram/WhatsApp. НЕ ставь "
        "двойные звёздочки **текст** - они не работают в мессенджере и покажутся студенту "
        "буквально как звёздочки в тексте. Не выделяй жирным слишком много подряд - только "
        "по-настоящему ключевые слова, иначе выделение теряет смысл.\n"
        ...
        "сложную markdown-разметку - только звёздочки для жирного и \"- \" для списков.\n"
